...
#define FLAG_SYS_SUN_FLUTE_ACTIVE                                   (SYS_FLAGS + 0x9)
#define FLAG_SYS_MOON_FLUTE_ACTIVE                                  (SYS_FLAGS + 0xA)
#define FLAG_SYS_VERSION_OVERRIDE_FIRERED                           (SYS_FLAGS + 0xB)
#define FLAG_SYS_VERSION_OVERRIDE_LEAFGREEN                         (SYS_FLAGS + 0xC)
