...
#define EVO_FRIENDSHIP_SUN_FLUTE  16 // Pokémon levels up while FLAG_SYS_SUN_FLUTE_ACTIVE is set
#define EVO_FRIENDSHIP_MOON_FLUTE 17 // Pokémon levels up while FLAG_SYS_SUN_FLUTE_ACTIVE is set
